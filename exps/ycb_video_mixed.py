...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 1.33
        self.width = 1.25
        self.exp_name = "ycb_video_mixed"

        # Define yourself dataset path
        self.data_dir = "./datasets/ycb_video_mixed/"
        self.train_name = "train2017/" # name of the training folder
        self.val_name = "val2017/" # name of the validation folder
